...
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
input_path=('/Users/rosslab/Documents/Ross Lab/MTT&Spot-On analysis/Simulated traj analysis from Ryan/20210129 Ryan movie D2-D4/9.5ms/D2/Frame rate test/380ms tiff/');
output_path_Name=sprintf('/Users/rosslab/Documents/Ross Lab/MTT&Spot-On analysis/Simulated traj analysis from Ryan/20210129 Ryan movie D2-D4/9.5ms/D2/Frame rate test/Search for best Dmax 380ms/Dmax=[0.1:0.1:1]/mat file Dmax=%d Gap=2/', D_in(n));
output_path=(output_path_Name);

% add the neccesary paths:bb
...
ExposureTime = 380; % in milliseconds
...
% imaging parameters
impars.PixelSize=0.10667; % um per pixel
