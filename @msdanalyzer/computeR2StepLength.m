function obj = computeR2StepLength(obj, indices)
...
%     M2_msd2     = zeros(n_delays, 1);
    ...
    itrack_msd  = NaN(n_delays,n_detections-1);
    ...
    for j = 1 : n_detections - 1
        ...
        itrack_msd(index_in_all_delays,j) = dr2;
...
%     mean_msd( delay_not_present ) = NaN;
    ...
    obj.msd{index} = [ delays itrack_msd n_msd ];
